                        ...
                        <div class="px-5 py-4 bg-white sm:p-6">
                            ...
                            @foreach($stokRetails as $stokRetail)
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="text" name="stok" id="stok" value="{{ $stokRetail->stok }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                            </div>
                            @endforeach
                        </div>
