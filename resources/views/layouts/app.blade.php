            ...
            <div class="flex flex-wrap bg-gray-100 w-full h-screen">
                <div class="w-1/5 bg-white rounded p-3 shadow-lg">
                    ...
                    <ul class="space-y-2 text-sm">
                        <li>
                            <a href="{{ route('supplier/dashboard') }}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 bg-gray-200 focus:shadow-outline">
                        ...
                        <li>
                            <a href="{{ route('supplier/form-tambah-barang') }}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                            <span width="20" height="20" data-feather="plus-circle"></span>
                                <span class="font-bold">Tambah Stok</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('supplier/stok') }}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                            <span width="20" height="20" data-feather="box"></span>
                                <span class="font-bold">Stok</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('supplier/permintaan') }}" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                                <span width="20" height="20" data-feather="shopping-cart"></span>
                                <span class="font-bold">Permintaan Pesanan</span>
                            </a>
                        </li>
                        <li>
